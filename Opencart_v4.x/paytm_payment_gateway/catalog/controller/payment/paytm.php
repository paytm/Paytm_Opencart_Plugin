...
class Paytm extends \Opencart\System\Engine\Controller {
	...
	public function callback(): void { 
		...
		$order_info = $this->model_checkout_order->getOrder($order_id);	  
		if(!empty($order_info)){ 
			if($this->config->get('payment_paytm_approved_status_id')!==$order_info['order_status_id'] && $this->config->get('payment_paytm_failed_status_id')!==$order_info['order_status_id']){    
